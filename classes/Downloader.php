...
namespace Theofficialvkr\Library;

use Theofficialvkr\Library\Exception\TheofficialvkrLibraryException;
use Theofficialvkr\Library\Exception\AvconvException;
use Theofficialvkr\Library\Exception\EmptyUrlException;
use Theofficialvkr\Library\Exception\InvalidProtocolConversionException;
use Theofficialvkr\Library\Exception\InvalidTimeException;
use Theofficialvkr\Library\Exception\PasswordException;
use Theofficialvkr\Library\Exception\PlaylistConversionException;
use Theofficialvkr\Library\Exception\PopenStreamException;
use Theofficialvkr\Library\Exception\RemuxException;
use Theofficialvkr\Library\Exception\WrongPasswordException;
use Theofficialvkr\Library\Exception\YoutubedlException;
...
class Downloader implements LoggerAwareInterface
{
     ...
     * @throws TheofficialvkrLibraryException
     * @throws AvconvException If avconv/ffmpeg is missing
